                        ...
                        <?php
                            ...
                            if($result = mysqli_query($link, $sql)){
                                if(mysqli_num_rows($result) > 0){
                                    ...
                                    $response = "<span>No se encontraron productos</span>";
                                }
                            } else{
                                $response = "<span>Ha ocurrido un error, intentelo nuevamente y si el mismo persiste comuniquese con nosotros</span>";
                            }
