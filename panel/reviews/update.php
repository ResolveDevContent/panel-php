...
if(isset($_POST["id"]) && !empty($_POST["id"])){
    ...
    if(empty($avatar_err) && empty($nombre_err) && empty($texto_err) && empty($estrellas_err)){
        ...
        $sql = "UPDATE reviews SET nombre=?, texto=?, empresa=?, estrellas=?, avatar=? WHERE id=?";

        if($stmt = mysqli_prepare($link, $sql)){
            // Bind variables to the prepared statement as parameters
            mysqli_stmt_bind_param($stmt, "sssssi", $param_nombre, $param_texto, $param_empresa, $param_estrellas, $param_avatar, $param_id);
                    ...
                    <div class="form-container d-flex flex-col">
                        ...
                        <form action="<?php echo htmlspecialchars(basename($_SERVER['REQUEST_URI'])); ?>" method="post" enctype="multipart/form-data" class="form d-flex flex-col">
                            ...
                            <div class="input">
                                ...
                                <input type="number" name="estrellas" class="form-control" value="<?php echo $estrellas; ?>">
                            </div>
                            <span>Avatar</span>
                            ...
                            <footer class="d-flex justify-end">
                                ...
                                <a href="reviews.php" class="btn btn-error">Cancelar</a>
                            </footer>
                        </form>
                    </div>
                </div>
